...
public class CrearProfesor extends javax.swing.JFrame {
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        if (nombre.isEmpty() || apellidos.isEmpty() || usuario.isEmpty() || password.isEmpty()) {
            JOptionPane.showMessageDialog(rootPane, "Ningun campo puede estar vacio");
        } else {
            ...
            p.usuario = usuario;
            p.password = password;
            p.especialidad = jComboBox1.getSelectedItem().toString();
            ...
            //boolean segura = VerificadorPassword.passwordSegura(p.password);
            /**
             * if (segura) { LoginA.profesores.add(p);
             * JOptionPane.showMessageDialog(rootPane, "Profesor creado");
             *
             * jTextField1.setText(""); jTextField3.setText("");
             * jTextField4.setText(""); jTextField5.setText("");
             *
             * } else { JOptionPane.showMessageDialog(rootPane, "La contraseña
             * no es segura"); }
             */
        }
